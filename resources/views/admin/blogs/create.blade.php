    ...
    <div class="flex justify-center items-center min-h-[85vh] bg-gray-50">
        <div class="w-full max-w-screen-2xl bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
            ...
            <form action="{{ route('admin.blogs.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                {{-- Category --}}
                <div>
                    <label for="category_name" class="block text-lg font-semibold text-gray-700 mb-2">
        ...
        focus:ring-2 focus:ring-[#FBD55B] focus:border-[#FBD55B]"
                ...
                {{-- Blog Date --}}
                <div>
                    <label for="blog_date" class="block text-lg font-semibold text-gray-700 mb-2">
                ...
                {{-- Context --}}
                <div>
                    <label for="context" class="block text-lg font-semibold text-gray-700 mb-2">Content</label>
