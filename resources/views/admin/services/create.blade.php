            ...
            <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <div id="benefits-container" class="space-y-3">
                        <div class="flex gap-2">
                            ...
                            <button type="button"
                                class="add-benefit px-3 py-2 bg-[#FBD55B] text-black font-semibold rounded-lg hover:bg-[#e4c14e] transition">+</button>
                ...
                <div>
                    ...
                    <div id="inclusions-container" class="space-y-3">
                        <div class="flex gap-2">
                            ...
                            <button type="button"
                                class="add-inclusion px-3 py-2 bg-[#FBD55B] text-black font-semibold rounded-lg hover:bg-[#e4c14e] transition">+</button>
                ...
                <div
                    ...
                    <div id="service_image_preview_container" class="hidden mt-4">
                        ...
                        <div id="service_image_preview" class="relative inline-block rounded-lg overflow-visible shadow-md">
                        </div>
                    </div>
                ...
                <div
                    ...
                    <p class="text-lg text-gray-500 mb-4">Accepted formats: JPG, PNG, WEBP — Max size: 1MB</p>
                    ...
                    <div id="icon_image_preview_container" class="hidden mt-4">
                        ...
                        <div id="icon_image_preview" class="relative inline-block rounded-lg overflow-visible shadow-md">
                        </div>
                    </div>
