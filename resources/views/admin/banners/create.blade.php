...
@section('admin-content')
    <div class="flex justify-center items-center min-h-[85vh] bg-gray-50">
        <div class="w-full max-w-screen-2xl bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
            ...
            <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                {{-- Title --}}
                <div>
                    <label for="title" class="block text-lg font-semibold text-gray-700 mb-2">Title <span
                ...
                {{-- Context (CKEditor) --}}
                <!-- <div>
                    <label for="context" class="block text-lg font-semibold text-gray-700 mb-2">Context</label>
    ...
    @enderror
                ...
                {{-- Link --}}
                <!-- <div>
                    <label for="link" class="block text-lg font-semibold text-gray-700 mb-2">Link (Optional)</label>
