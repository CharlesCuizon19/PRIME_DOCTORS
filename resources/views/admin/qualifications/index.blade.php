                    ...
                    <tr class="border-t">
                        ...
                        <td class="px-6 py-3 text-center">
                            <form action="{{ route('admin.qualifications.destroy', $qualification->id) }}" method="POST"
                                ...
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="px-3 py-1 rounded text-white bg-red-500 hover:bg-red-600">
                                    Delete
                                </button>
                            </form>
                        </td>
    ...
    <div id="create-modal" class="fixed inset-0 bg-black bg-opacity-50 hidden flex items-center justify-center z-50">
        <div class="bg-white rounded-3xl shadow-lg p-8 w-[600px] max-w-full">
            ...
            <form method="POST" action="{{ route('admin.qualifications.store') }}">
                @csrf
                <div class="mb-4">
                    <label for="qualification" class="block text-lg font-medium text-gray-700">Qualification Name</label>
