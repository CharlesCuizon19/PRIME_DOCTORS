    ...
    <div class="flex justify-center items-center min-h-[85vh] bg-gray-50">
        <div class="w-full max-w-screen-2xl bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
            ...
            <form action="{{ route('admin.doctors.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    <label for="clinic_hours" class="block text-lg font-semibold text-gray-700 mb-2">
                        Clinic Hours
                    </label>
                    <select name="clinic_hours" id="clinic_hours"
                        ...
                        <option value="Mon–Fri 8AM–12PM" {{ old('clinic_hours') == 'Mon–Fri 8AM–12PM' ? 'selected' : '' }}>
                            Mon–Fri 8AM–12PM</option>
                        <option value="Mon–Fri 1PM–5PM" {{ old('clinic_hours') == 'Mon–Fri 1PM–5PM' ? 'selected' : '' }}>
                            Mon–Fri 1PM–5PM</option>
                        <option value="Mon–Fri 9AM–6PM" {{ old('clinic_hours') == 'Mon–Fri 9AM–6PM' ? 'selected' : '' }}>
                            Mon–Fri 9AM–6PM</option>
                        <option value="Mon–Sat 9AM–6PM" {{ old('clinic_hours') == 'Mon–Sat 9AM–6PM' ? 'selected' : '' }}>
                            Mon–Sat 9AM–6PM</option>
                        <option value="Sat 9AM–1PM" {{ old('clinic_hours') == 'Sat 9AM–1PM' ? 'selected' : '' }}>Sat
                            9AM–1PM</option>
                        <option value="Sun 10AM–3PM" {{ old('clinic_hours') == 'Sun 10AM–3PM' ? 'selected' : '' }}>Sun
                            10AM–3PM</option>
                        <option value="Daily 8AM–8PM" {{ old('clinic_hours') == 'Daily 8AM–8PM' ? 'selected' : '' }}>Daily
                            8AM–8PM</option>
                    </select>
                    @error('clinic_hours')
                        <p class="text-red-600 text-lg mt-1">{{ $message }}</p>
                ...
                {{-- Phone Number --}}
                <div>
                    <label for="phone_num" class="block text-lg font-semibold text-gray-700 mb-2">
                        Mobile Number
                    </label>
                ...
                {{-- Telephone --}}
                <div>
                    <label for="telephone_num" class="block text-lg font-semibold text-gray-700 mb-2">
                        Telephone Number
                    </label>
                ...
                <div>
                    ...
                    <div id="specializations-container" class="space-y-3">
                        <div class="flex gap-2 specialization-row">
                            ...
                            <select name="specializations[0][type]"
                                class="flex-1 border border-gray-300 rounded-lg px-4 py-2">
                ...
                <div
                    ...
                    <label for="doctor_image_id"
                        ...
                        <input type="file" name="doctor_image_id" id="doctor_image_id" class="hidden"
                            accept="image/*">
                    </label>
                </div>
