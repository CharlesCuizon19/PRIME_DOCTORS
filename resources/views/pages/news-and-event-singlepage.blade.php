        ...
        <div class="container flex flex-col gap-10 px-4 py-32 mx-auto md:px-8 lg:px-16 lg:flex-row">
            ...
            <div class="w-full lg:w-2/3">
                ...
                <div class="w-full h-fit">
                    ...
                    @else
                        <img src="{{ asset('assets/post-details-img.png') }}" alt="Default News Image"
                            class="object-cover w-full mb-6 rounded-2xl shadow-md opacity-80">
                    @endif
                </div>

                <!-- Meta Info -->
                <div class="flex items-center gap-8 mb-3 text-lg text-gray-600">
                    ...
                    <div class="divide-y">
                        ...
                        @foreach ($latest_news as $item)
                            <a href="{{ route('news-and-events.singlepage', ['id' => $item->id]) }}"
                                ...
                                <div class="space-y-3">
                                    <h3 class="text-lg font-semibold leading-snug text-gray-800">
                                        {{ $item->title }}
                                    </h3>
                                    <p class="flex items-center justify-start gap-2 mb-2 text-lg text-[#edb42f]">
