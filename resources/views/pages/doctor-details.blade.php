            ...
            <div class="flex flex-col gap-20">
                    ...
                    <div class="absolute inset-0">
                        <div class="grid items-center h-full grid-cols-1 2xl:grid-cols-5">
                            <div class="ml-[10rem] col-span-2 w-fit">
                                ...
                                @else
                                    <img src="{{ asset('assets/doctor-thumbnail2.png') }}" alt="Default Doctor"
                            ...
                            <div class="flex flex-col col-span-3">
                                <div class="flex flex-col gap-3 pb-5 mr-10 border-b-2">
                                    ...
                                    <div class="text-md text-[#edb42f] font-semibold">
                                        <span
                                            class="text-[#edb42f]">{{ $primarySpecialization->specialization_name }}</span>
                                    </div>
                                </div>
                                <div class="grid grid-cols-2 gap-10 pt-5">
                                    <div class="flex flex-col gap-2">
                                        <span class="text-lg font-semibold text-gray-500">Sub-specialization</span>
                                        <div>
                                            {{ $subSpecializations->pluck('specialization_name')->join(', ') }}
                                        </div>
                                    </div>
                                    <div class="flex flex-col gap-2">
                                        <span class="text-lg font-semibold text-gray-500">Language</span>
                                        <div>
                                            {{ $doctor->languages->pluck('language')->join(', ') }}
                                        </div>
                                    </div>
                                    <div class="flex flex-col gap-2">
                                        <span class="text-lg font-semibold text-gray-500">Clinic Room Number</span>
                                        <div>
                                            {{ $doctor->clinic_room_number }}
                                        </div>
                                    </div>
                                    <div class="flex flex-col gap-2">
                                        <span class="text-lg font-semibold text-gray-500">Clinic Hours</span>
                                        <div>
                                            {{ $doctor->clinic_hours }}
                                        </div>
                                    </div>
                                    <div class="flex flex-col gap-2">
                                        <span class="text-lg font-semibold text-gray-500">Phone Number</span>
                                        <div>
                                            {{ $doctor->phone_num }}
                                        </div>
                                    </div>
                                    <div class="flex flex-col gap-2">
                                        <span class="text-lg font-semibold text-gray-500">Telephone Number</span>
                                        <div>
                ...
                <div class="flex flex-col justify-between gap-32 rounded-lg lg:flex-row">
                    ...
                    <div class="flex flex-col justify-between w-full rounded-lg lg:w-2/3">
                        ...
                        <p class="mt-5 text-lg italic text-gray-600">
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <div class="flex items-start justify-start w-full cursor-pointer">
                                <a href="{{ route('find-a-doctor.show') }}"
                                    ...
                                    <div class="text-lg font-semibold">FIND A DOCTOR</div>
