        ...
        <div>
            ...
            <div class="flex flex-col pt-10 space-y-8">
                <div class="flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 24 24" class="text-[#edb42f]">
                        ...
                        <circle cx="12" cy="8" r="5" fill="currentColor" stroke-width="0.5" stroke="currentColor" />
                    </svg>
