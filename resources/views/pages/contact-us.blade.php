                ...
                <div class="p-8 bg-white shadow-md rounded-2xl h-fit" data-aos="zoom-in" data-aos-duration="1000">
                    ...
                    <form id="contactForm" action="{{ route('contacts.store') }}" method="POST"
                        ...
                        <button id="submitBtn" type="submit"
                            ...
                            <svg id="btnSpinner" class="hidden animate-spin h-6 w-6 text-white" xmlns="http://www.w3.org/2000/svg"
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        form.addEventListener("submit", async function(e) {
            ...
            form.querySelectorAll("input, textarea, select").forEach(el => el.classList.remove("ring-2", "ring-red-500"));
                ...
                if (response.status === 422) {
                    ...
                    Object.keys(errors).forEach(field => {
                        ...
                        if (input) {
                            ...
                            errorSpan.className = "text-red-600 text-sm mt-2 block";
