                ...
                <div class="grid grid-cols-1 gap-16 md:grid-cols-2 lg:grid-cols-4">
                    @foreach ($services as $service)
                        <div class="relative flex flex-col items-center text-center group" data-aos="zoom-in"
                            ...
                            <div
                                class="absolute -top-10 flex items-center justify-center w-20 h-20 bg-[#FBBF24] rounded-full shadow-md z-30">
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <ul class="text-gray-800 text-lg list-disc list-inside text-left space-y-1">
