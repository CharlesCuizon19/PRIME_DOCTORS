                    ...
                    <div class="p-6">
                        ...
                        <form id="appointmentForm" action="{{ route('appointments.store') }}" method="POST" class="space-y-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-red-600 error-message" data-field="doctor_id"></p>
                            </div>

                            <div>
                                <input type="text" name="full_name" placeholder="Full Name"
                                    class="w-full px-5 py-3 border rounded-full">
                                <p class="mt-1 text-sm text-red-600 error-message" data-field="full_name"></p>
                            </div>

                            <div>
                                <input type="text" name="phone_number" placeholder="Phone No."
                                    class="w-full px-5 py-3 border rounded-full">
                                <p class="mt-1 text-sm text-red-600 error-message" data-field="phone_number"></p>
                            </div>

                            <div>
                                <input type="date" name="appointment_date"
                                    class="w-full px-5 py-3 border rounded-full">
                                <p class="mt-1 text-sm text-red-600 error-message" data-field="appointment_date"></p>
                            </div>
