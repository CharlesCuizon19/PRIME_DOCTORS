    ...
    <template x-teleport="body">
        <div x-show="open" x-transition x-cloak class="fixed inset-0 z-[9999] flex items-center justify-center p-4"
            ...
            <div @click.stop x-transition.scale.origin.center
                class="relative z-10 w-full p-5 max-w-xl h-fit max-h-[90%] overflow-y-auto bg-white text-gray-100 border border-gray-700 rounded-xl shadow-2xl">
                <!-- Header -->
                <div
                    class="sticky top-0 flex items-center justify-between py-4 mb-5 bg-white border-b border-gray-700/30">
                    <h2 class="text-xl font-semibold text-black">Apply for this position</h2>
                    <button @click="open = false"
                        class="px-[5px] py-1 text-base leading-none text-white bg-red-600 rounded-full hover:text-white">
                        ✕
                    </button>
                </div>
                ...
                <form action="#" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="mb-6">
                        ...
                        <div
                            ...
                            <label
                                ...
                                Upload File
                                <input type="file" name="resume" accept=".pdf,.doc,.docx" class="hidden" required>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col justify-between gap-3 sm:flex-row">
                        <button @click = "open = false"
                            class="flex items-center gap-5 px-1 py-1 text-white transition duration-300 rounded-full shadow bg-[#838383] hover:scale-105 hover:shadow-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="rotate-180 h-7 lg:h-14">
                                <g fill="none" stroke="currentColor" stroke-width="1">
                                    <circle cx="12" cy="12" r="10" />
                        ...
                        <button type="submit"
                            class="flex items-center gap-5 px-1 py-1 text-white transition duration-300 rounded-full shadow bg-[#0035c6] hover:scale-105 hover:shadow-lg">
                            <span class="ml-5 mr-5 text-base font-semibold text-nowrap">SUBMIT APPLICATION</span>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-7 lg:h-14">
                                <g fill="none" stroke="currentColor" stroke-width="1">
                                    <circle cx="12" cy="12" r="10" />
                                    <path stroke-linecap="round" stroke-linejoin="round"
