        ...
        <div class="container absolute inset-0 flex flex-row items-center mx-auto">
            <div class="flex items-center pr-[20rem] w-full gap-14 text-gray-800">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-lg font-bold text-white lg:text-lg">24/7 Emergency Services</span>
                </div>
                <div class="flex items-center space-x-2">
                    <img src="{{ asset('assets/icon2.png') }}" class="w-6 h-6">
                    <span class="text-lg font-bold text-white lg:text-lg">Specialized Doctors</span>
                </div>
                <div class="flex items-center space-x-2">
                    <img src="{{ asset('assets/icon3.png') }}" class="w-6 h-6">
                    <span class="text-lg font-bold text-white lg:text-lg">Patient-Centric Care</span>
                </div>
            </div>
        </div>
    </div>
