<div class="flex items-center justify-center py-12 bg-white">
    <div class="container grid items-center justify-center max-w-6xl gap-10 p-6 mx-auto text-center lg:grid-cols-1">
        <div class="flex items-center justify-center">
            <div class="px-4 py-1 text-lg font-semibold text-blue-700 bg-gray-100 rounded-full w-fit h-fit"
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            @foreach ($news as $item)
                <a href="{{ route('news-and-events.singlepage', ['id' => $item->id]) }}"
                    class="overflow-hidden transition duration-300 cursor-pointer hover:scale-105" data-aos="zoom-in"
                    ...
                    <div class="py-4 text-left">
                        <p class="flex items-center justify-start gap-2 mb-2 text-lg text-[#edb42f]">
